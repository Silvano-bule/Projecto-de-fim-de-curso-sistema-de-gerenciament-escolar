        ...
        <div class="px-6 py-4">
            ...
            <form action="index.php?page=cadastrar" method="post" autocomplete="off">
                ...
                <div class="w-full mt-4">
                    ...
                    <select name="tipo" id="tipo" required class="block w-full px-4 py-2 mt-2 text-gray-700 placeholder-gray-500 bg-white border rounded-lg dark:bg-gray-800 dark:border-gray-600 dark:placeholder-gray-400 focus:border-blue-400 dark:focus:border-blue-300 focus:ring-opacity-40 focus:outline-none focus:ring focus:ring-blue-300">
                        <option value="" disabled selected>Selecione o tipo de usuario</option>
                        <option value="admin">admin</option>
                        <option value="professor">Professor</option>
                    </select>
                    <?php if (isset($error['tipo'])): ?>
                        <p class="text-red-500 text-sm"><?= htmlspecialchars($error['tipo']) ?></p>
                    <?php endif; ?>
                </div>
