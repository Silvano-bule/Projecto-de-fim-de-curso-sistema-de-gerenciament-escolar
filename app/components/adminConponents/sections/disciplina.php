            ...
            <section class="container px-4 mx-auto">
                <div class="flex flex-col gap-4 mt-6">
                    <div class="flex flex-row justify-between items-center mt-8">
                        <div>
                            <h1 class="text-2xl font-bold text-white">Disciplina</h1>
                            <p>Gerencie todos os Disciplinas cadastradas</p>
                        </div>
                        <button class="flex flow-row items-center bg-blue-500 text-white rounded-md px-3 cursor-pointer" id="professor" onclick="document.getElementById('modal_disc').showModal()">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M12 4.5v15m7.5-7.5h-15" />
                            </svg>
                            <div tabindex="0" role="button" class="m-2">Nova Disciplina</div>
                        </button>
                    </div>
                                                ...
                                                <td class="px-4 py-4 text-sm font-medium text-gray-700 whitespace-nowrap">
                                                    <div class="inline-flex items-center gap-x-3">
                                                        <div class="flex items-center gap-x-2">
                                                            ...
                                                            <div>
                                                                <h2 class="font-medium text-gray-800 dark:text-white "><?= $disciplina['nome'] ?></h2>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td>
                                                    <div class="dropdown dropdown-hover">
                                                        ...
                                                        <ul class="dropdown-content menu bg-base-100 rounded-box w-52 p-2 shadow-sm  absolute right-0">
                                                            <li>
                                                                <a onclick="removerDisciplina(<?= $disciplina['id'] ?>)">
                                                            ...
                                                            <li>
                                                                <a onclick="obterDisciplina(<?= $disciplina['id'] ?>)">
                    ...
                    <div class="container mx-auto py-4">
                        ...
                        <div class="grid grid-cols-3 gap-7">
                            <div class="element-disciplina ">
                                <div>
                                    <!-- icone -->
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6 icone-style">
    ...
    <script src="assets/js/disciplina.js"></script>