            ...
            <section class="container px-4 mx-auto">
                <div class="flex flex-col gap-4 mt-6">
                    <div class="flex flex-row justify-between items-center mt-8">
                        ...
                        <button class="flex flow-row items-center bg-blue-500 text-white rounded-md px-3 cursor-pointer" id="professor" onclick="document.getElementById('modal_curso').showModal()">
                                                    ...
                                                    <div class="inline-flex items-center gap-x-3">
                                                        <div class="flex items-center gap-x-2">
                                                            ...
                                                            <div>
                                                                ...
                                                                <p class="text-sm font-normal text-gray-600 dark:text-gray-400"><span class="text-sm font-normal text-gray-600 dark:text-gray-400 ml-10"><?= $curso['descricao'] ?> </span></p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td>
                                                    <div class="dropdown dropdown-hover">
                                                        ...
                                                        <ul class="dropdown-content menu bg-base-100 rounded-box w-52 p-2 shadow-sm  absolute right-0">
                                                            <li>
                                                                <a onclick="removerCurso(<?= $curso['id'] ?>)">
