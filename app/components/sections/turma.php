                                                    ...
                                                    <div class="inline-flex items-center gap-x-3">
                                                        <div class="flex items-center gap-x-2">
                                                            ...
                                                            <div>
                                                                ...
                                                                <p class="text-sm font-normal text-gray-600 dark:text-gray-400"><?= $turma['periodo'] ?> <span class="text-sm font-normal text-gray-600 dark:text-gray-400 ml-10"></span></p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td>
                                                    <div class="dropdown dropdown-hover">
                                                        ...
                                                        <ul class="dropdown-content menu bg-base-100 rounded-box w-52 p-2 shadow-sm  absolute right-0">
                                                            <li>
                                                                <a onclick="removerTurma(<?= $turma['id'] ?>)">
