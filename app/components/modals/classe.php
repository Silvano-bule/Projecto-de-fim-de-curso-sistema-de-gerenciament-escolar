    ...
    <dialog id="modal_classe" class="modal">
        <div class="modal-box w-screen max-w-5xl">
            ...
            <form action="index.php?page=classe&action=render" method="POST">
                <input type="hidden" id="id_classe" name="idClasse">
