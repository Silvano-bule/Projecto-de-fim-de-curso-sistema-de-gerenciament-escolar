    ...
    <dialog id="modal_curso" class="modal">
        <div class="modal-box w-screen max-w-2xl">
            ...
            <form action="index.php?page=Curso&action=render" method="POST" id="formulario">
                <input type="hidden" id="id_curso" name="idCurso">
                <div class="grid grid-cols-1 gap-6 mt-4 sm:grid-cols-2 md:grid-cols-3 xl:grid-cols-2">
                    <div>
                        ...
                        <input placeholder="Ex: Informática, CFB, CEJ..." name="nome_curso" type="text" id="Name_curso" class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-200 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-400 focus:ring-blue-300 focus:ring-opacity-40 dark:focus:border-blue-300 focus:outline-none focus:ring" required>
                    ...
                    <div>
                        <label class="text-gray-700 dark:text-gray-200" for="descricao">Descrição<span class="text-red-500 text-xs"> (Obrigatório)</span> </label>
                        <input placeholder="Texto sobre o curso" name="descricao_curso" id="Desc_curso" type="text" class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-200 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-400 focus:ring-blue-300 focus:ring-opacity-40 dark:focus:border-blue-300 focus:outline-none focus:ring" required>
